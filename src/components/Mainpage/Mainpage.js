...
import wolfphoto from './wolfphoto.png';
    ...
    return(
        <div>
            <div className='flexbox-container'>
                ...
                <div>
                    <ul className='nav-options nav-options-hide'>
                        <li>
            ...
            <div className='flexbox-container-2 container-md'>
                <div className='flexbox-item flexbox-item-21'>
                    <ul className='left-bar-options'>
                        <li className='left-bar-option-1'>
                            <h6>Name</h6>
                        </li>
                        <li className='left-bar-option-2'>
                            Friends
                        </li>
                        <li className='left-bar-option-3'>
                            Teams
                        </li>
                        <li className='left-bar-option-4'>
                            Marketplace
                        </li>
                        <li className='left-bar-option-5'>
                            Watch
                        </li>
                        <li className='left-bar-option-6'>
                            Memories
                        </li>
                        <li className='left-bar-option-7'>
                            Saved
                        </li>
                        <li className='left-bar-option-8'>
                            More
                        </li>
                    </ul>
                ...
                <div className='flexbox-item flexbox-item-22'>
                    <div>
                        <img src={download} alt="cute dog"/>
                        <img src={download} alt="cute dog"/>
                        <img src={download} alt="cute dog"/>
                        <img src={download} alt="cute dog"/>
                        <img src={download} alt="cute dog"/>
                    ...
                    <div className='self'>
                        ...
                        </svg><input type="text" placeholder=' What are you thinking?' className='what-you-think'></input>
                        <ul className='personal-update'>
                            <li>Video</li>
                            <li>Photos</li>
                            <li>How you feel</li>
                        </ul>
                ...
                <div className='flexbox-item flexbox-item-23'>
                    <h6 class="container text-secondary">Games</h6>
                    <div class="card">
                        <img class="card-img" src={gamephoto} alt="Rex"/>
                        <div class="card-img-overlay">
                            <h1 class="card-title">Specific games</h1>
                            <p class="card-text lh-sm text-dark">This is an awesome game</p>
                        </div>
                    </div>

                    <div className='advert'>
                        <img src={wolfphoto} className="wolf"/>
                        <div className='advert-details'>
                        <h4>Wolf</h4>
                        <a href='#' className='use-link'>wolf.com</a>
                        </div>
                    </div>

                    <div>
                        <h3>Friends</h3>
                        <ul className='friend-names'>
                            <li>Name 1</li>
                            <li>Name 2</li>
                            <li>Name 3</li>
                            <li>Name 4</li>
